    ...
    methods
        ...
        function obj = mtu(varargin)
            ...
            obj.g(obj.x_bins<-5) = obj.g_parameters(1) + ...
                abs(0.01*1e0*((obj.x_bins(obj.x_bins<-5)+5).^3));
            obj.g(obj.x_bins>=-5) = obj.g_parameters(1) + ...
                0.01*5e1*((obj.x_bins(obj.x_bins>=-5)+5).^2);
            obj.g = obj.g + 0;
...
%             TO ESTIMATE change in force with filament overlap
        ...
        function shift_cbDist(obj,delta_x)
            ...
            obj.bin_pops = interp1(obj.x_bins,obj.y(2:end-2),interp_positions, ...
                'linear',0)';
