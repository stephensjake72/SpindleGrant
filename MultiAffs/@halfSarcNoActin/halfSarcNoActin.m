classdef halfSarcNoActin < handle
    ...
    methods
        ...
        function obj = halfSarcNoActin(varargin)
...
%             obj.g = obj.g + 1;
            ...
            obj.y = [obj.f_activated-sum(obj.bin_pops) ; obj.bin_pops; 1; 0];
        ...
        function update_fracBound(obj)
            ...
            obj.y(1) = obj.f_activated-obj.f_bound;
        end
...
%             obj.no_detached = max([0 obj.f_overlap * obj.f_activated - obj.f_bound]);
            ...
            f_actin_bound = sum(n_myosin_attached);
                ...
                % much)
                J1 = obj.f .* obj.bin_width * f_myosin_detached;
                ...
                dy(end-1) = 1-f_actin_ON;
                dy(end) = f_actin_ON-sum(dy(2:end-2));
