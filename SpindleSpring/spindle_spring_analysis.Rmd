...
rampdf %>% lmerTest::lmer(formula = mvf ~ KT + (1|unID)) %>% summary()
rampdf %>% lmerTest::lmer(formula = mvmt ~ KT + (1|unID)) %>% summary()
rampdf %>% lmerTest::lmer(formula = mFmt ~ KT + (1|unID)) %>% summary()
rampdf$mFmt[rampdf$KT == 'T'] %>% describe() 
rampdf$mFmt[rampdf$KT == 'C'] %>% describe() 
rampdf$rFmt[rampdf$KT == 'T'] %>% describe() 
rampdf$rFmt[rampdf$KT == 'C'] %>% describe() 
