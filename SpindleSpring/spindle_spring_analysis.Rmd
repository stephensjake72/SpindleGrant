...
ggsave('/Users/jacobstephens/Documents/Figures/Abbott_Stephens_manuscript/fig1stats.eps', device = 'eps', plot = last_plot())
ggsave('/Users/jacobstephens/Documents/Figures/Abbott_Stephens_manuscript/fig1stats.jpg', device = 'jpg', plot = last_plot())
```
...
sinedf %>% lmerTest::lmer(formula = rvf ~ KT + (1|unID)) %>% summary()
...
ggsave('/Users/jacobstephens/Documents/Figures/Abbott_Stephens_manuscript/fig2stats.eps', device = 'eps', plot = last_plot(), 
       width = 2, height = 4, units = 'in')
ggsave('/Users/jacobstephens/Documents/Figures/Abbott_Stephens_manuscript/fig2stats.jpg', device = 'jpg', plot = last_plot())
```
...
# compare regression slopes
rampdf %>% lmerTest::lmer(formula = mLf ~ KT + (1|unID)) %>% summary()
rampdf %>% lmerTest::lmer(formula = mLmt ~ KT + (1|unID)) %>% summary()
rampdf %>% lmerTest::lmer(formula = rvf ~ KT + (1|unID)) %>% summary()
rampdf %>% lmerTest::lmer(formula = rvmt ~ KT + (1|unID)) %>% summary()
rampdf %>% lmerTest::lmer(formula = mFmt + KT + (1|unID)) %>% summary()
...
ggsave('/Users/jacobstephens/Documents/Figures/Abbott_Stephens_manuscript/fig3stats.eps', device = 'eps', plot = last_plot(),
       width = 2, height = 6, units = 'in')
ggsave('/Users/jacobstephens/Documents/Figures/Abbott_Stephens_manuscript/fig3stats.jpg', device = 'jpg', plot = last_plot())
```
# Triangles analysis
```{r}
...
tridf %>% lmerTest::lmer(formula = rvf ~ KT + (1|unID)) %>% summary()
tridf %>% lmerTest::lmer(formula = rvmt ~ KT + (1|unID)) %>% summary()
